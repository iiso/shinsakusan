     ...
     <section class="search-area">
      ...
      <div class="search-area-tab">
            <ul id="tabnavi" class="tab">
               ...
               <li class="right on"><a href="./home_old.php"><span>過去に発売</span></a></li>
            </ul>
        </div>
    </section>
         ...
         <li class="release-info-box">
            ...
            <div class="text">
              <p class="release-title">
                <a href="artist.php?id=<?php print($item["musician_id"]); ?>" target="_blank">
                <a><?php print($item["m_name"]); ?></a>
              </p>
	            <p class="name">
                <a href="artist.php?id=<?php print($item["musician_id"]); ?>">
                <a><?php print ($item["name"]); ?></a>
              </p>
            </div>
          </li>
