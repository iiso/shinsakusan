 ...
 */
 ...
 (function($){
	...
	$.fn.tablePagination = function(settings) {
		var defaults = {  
			firstArrow : ((settings.firstArrow)? settings.firstArrow: (new Image()).src="./images/first.gif"),
			prevArrow  : ((settings.prevArrow)? settings.prevArrow: (new Image()).src="./images/prev.gif"),
			lastArrow  : ((settings.lastArrow)? settings.lastArrow: (new Image()).src="./images/last.gif"),
			nextArrow  : ((settings.nextArrow)? settings.nextArrow: (new Image()).src="./images/next.gif"),
			rowsPerPage : 5,
			currPage : 1,
